...
tags: ["Structure", "Lattice", "Basis", "Wigner-Seitz Unit Cell", "Simple Cubic", "SC", "Face Centered Cubic", "FCC", "Body Centered Cubic", "BCC", "Miller Indices", "Reciprocal Lattice", "X-ray Scattering", "Interference", "Laue Conditions", "Waves in Crystal", "Structure Factor"]
categories: ["Physics"]
image: waves-in-crystals-img/feature.jpg
format:
  html: default
  pdf: default
---
...
![Lattice](waves-in-crystals-img/lattice.png)
...
![Structure](waves-in-crystals-img/structure.png)
...
![Unit Cell](waves-in-crystals-img/unit.png)
...
![Wigner-Seitz Cell](waves-in-crystals-img/wigner.png)
...
![Simple Cubic](waves-in-crystals-img/sc.png)
...
![Face Centered Cubic](waves-in-crystals-img/fcc.png)
...
![Body Centered Cubic](waves-in-crystals-img/bcc.png)
...
![Miller Indices Intersections](waves-in-crystals-img/miller_g.png)
...
![Miller Planes Examples](waves-in-crystals-img/miller_planes.jpg)
...
![Laue Conditions](waves-in-crystals-img/laue.png)
