...
For the security of your accounts the password manager [Secrets](https://gitlab.gnome.org/World/PasswordSafe) and [Seahorse](https://wiki.gnome.org/Apps/Seahorse/) is installed by default.
...
![Gnome 2 Layout](img/gnome.jpg)

![Cupertino Layout](img/cupertino.jpg)

![Redmond Layout](img/redmond.jpg)

![Mutiny Layout](img/mutiny.jpg)
...
Additionally for the text editor Pluma the official MATE package [pluma-plugins](https://github.com/mate-desktop/pluma-plugins) is now included by default. This transforms Pluma to a usable IDE with some plugins like bracket and word completion, quickhighlight, and source-code browser:
...
![Theme Pluma](img/theme-pluma.jpg)

![Theme Terminal](img/theme-terminal.jpg)

As you saw in these pictures the default font across the whole desktop is [Fira Code](https://github.com/tonsky/FiraCode).

### Wallpapers

Here are some of the wallpapers included in the ISO:

![John Towner - Unsplash](img/john-towner-3Kv48NS4WUU-unsplash.jpg)

![Marina Montoya - Unsplash](img/marina-montoya-bqkmKInb_9E-unsplash.jpg)

![Paul Scherer - Unsplash](img/paul-scherer-1mAqQGg6FwI-unsplash.jpg)

![Scott Carroll - Unsplash](img/scott-carroll-qKcglCaZtTA-unsplash.jpg)
...
::: {.callout-note}
The ISO consists of two files because GitHub cannot handle files larger than 2 GB. You can find the guide on how to merge them in the [README](https://github.com/FreaxMATE/manjaro-iso-build)
:::

## Future Ideas

- Set [Picom](https://wiki.archlinux.org/title/Picom) as default compositor
